...
PROFILE_RULES: list[tuple[tuple[str, ...], str]] = [
    ...
    (("earliest start", "earliest available start", "available to start", "internship start date", "start availability"), "earliest_start_date"),
    (("latest end", "latest available end", "internship end date", "available through", "availability end"), "latest_end_date"),
